...
// Retirez les commentaires devant le code de Tom pour commencer
console.log(
    "Montant récolté auprès des 5 investisseurs : 5 x 470 = " +
        5 * 470 +
        " €\nMontant récolté auprès de 10 amis : 10 x 100 = " +
        10 * 100 +
        " €\nMontant total récolté : 2350 + 1000 = " +
        (2350 + 1000) +
        " €\nBénéfice net (après le prélèvement des taxes) : 2350 - 2350 * 0.12 + 1000 = " +
        (2350 - 2350 * 0.12 + 1000) +
        " €"
);
